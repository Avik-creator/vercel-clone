...
if [ -f pnpm-lock.yaml ]; then \
    ...
    let status = wait_for_status_with_timeout(async {
...
async fn wait_for_status_with_timeout<F>(wait: F, build_timeout: Duration) -> anyhow::Result<std::process::ExitStatus>
where
